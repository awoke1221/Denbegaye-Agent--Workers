...
exports.deepseekNode = void 0;
const zod_1 = require("zod");
const openai_1 = __importDefault(require("openai"));
// DeepSeek Node
const deepseekConfigSchema = zod_1.z.object({
    model: zod_1.z.enum(["deepseek-chat", "deepseek-coder"]).default("deepseek-chat"),
...
const deepseekNode = {
    ...
    handler: async (context) => {
        ...
        try {
            ...
            logs.push(`Error in DeepSeek node: ${error instanceof Error ? error.message : String(error)}`);
            return {
                success: false,
...
exports.deepseekNode = deepseekNode;
