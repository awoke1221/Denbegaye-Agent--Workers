...
// Facebook Node
const facebookConfigSchema = zod_1.z.object({
...
const facebookNode = {
    ...
    validation: {
        input: zod_1.z.object({
            action: zod_1.z.enum(["post", "getPosts", "comment", "like", "getComments"]),
        ...
        try {
            ...
            switch (input.action) {
                case "post":
                    ...
                    response = await axios_1.default.post(`${baseUrl}/${input.pageId}/feed`, postData, {
                ...
                case "getPosts":
                    ...
                    response = await axios_1.default.get(`${baseUrl}/${input.pageId}/posts`, {
                        params: {
                            access_token: accessToken,
                            limit: 10,
                        },
                ...
                case "comment":
                    ...
                    response = await axios_1.default.post(`${baseUrl}/${input.postId}/comments`, {
                        message: input.content,
                        access_token: accessToken,
                    }, {
                        timeout: config.timeout,
                ...
                case "like":
                    ...
                    response = await axios_1.default.post(`${baseUrl}/${input.postId}/likes`, {
                        access_token: accessToken,
                    }, {
                        timeout: config.timeout,
                    });
                ...
                case "getComments":
                    ...
                    response = await axios_1.default.get(`${baseUrl}/${input.postId}/comments`, {
                        params: {
                            access_token: accessToken,
                            limit: 10,
                        },
