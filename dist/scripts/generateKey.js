...
console.log("   • Store the key in a secure secrets management system (e.g., AWS Secrets Manager)");
...
console.log("   • If the key is compromised, regenerate it and re-encrypt all stored credentials");
console.log("\n");
console.log("🔄 Key Rotation:");
console.log("   • When rotating to a new key, use EncryptionService.rotateEncryptedValue()");
console.log("   • This allows decryption with the old key and re-encryption with the new key");
console.log("   • Update ENCRYPTION_KEY in your environment after running rotation");
console.log("\n");
process.exit(0);
