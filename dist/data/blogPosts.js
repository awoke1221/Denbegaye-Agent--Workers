...
exports.getBlogPostBySlug = exports.getAllBlogPosts = exports.blogPosts = void 0;
exports.blogPosts = [
    {
        slug: "how-denbegnaye-works",
        title: "How Denbegnaye Works: AI workflows made simple",
        summary: "Learn the core concepts behind Denbegnaye, including visual workflows, agent execution, and how to turn ideas into automated systems.",
        date: "2026-05-21",
    ...
    },
    {
        ...
        summary: "A step-by-step walkthrough for building your first AI agent, from account setup to workflow execution and review.",
        date: "2026-05-21",
        author: "Denbegnaye Team",
        readingTime: "7 min",
    ...
    },
    {
        ...
        summary: "Create a workflow that connects an AI step with an external API, demonstrating how Denbegnaye handles real-world automation scenarios.",
        date: "2026-05-21",
        author: "Denbegnaye Team",
        readingTime: "8 min",
...
const getAllBlogPosts = () => exports.blogPosts;
exports.getAllBlogPosts = getAllBlogPosts;
const getBlogPostBySlug = (slug) => exports.blogPosts.find((post) => post.slug === slug);
