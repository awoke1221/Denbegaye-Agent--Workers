    ...
    async startProcessing() {
        ...
        while (this.processing) {
            try {
                ...
                logger_1.logger.debug("Queue processor loop checking for jobs", {
                    availableSlots,
                ...
                logger_1.logger.debug("Fetched queued jobs from DB", {
                ...
                if (!jobs || jobs.length === 0) {
                    logger_1.logger.debug("No ready jobs found in queue", {
