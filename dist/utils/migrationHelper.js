...
exports.MigrationTools = exports.MigrationMonitor = exports.GradualMigrationExample = exports.MigrationFeatureFlag = exports.MigrationGuide = void 0;
exports.convertOldWorkflowToLangGraph = convertOldWorkflowToLangGraph;
exports.createWorkflowExecutionStatesTable = createWorkflowExecutionStatesTable;
exports.updateAgentExecutionsTable = updateAgentExecutionsTable;
exports.runAdvancedExecutionMigrations = runAdvancedExecutionMigrations;
exports.validateWorkflowCompatibility = validateWorkflowCompatibility;
const supabaseClient_1 = require("./supabaseClient");
/**
 * Convert old workflow format to LangGraph config
 */
function convertOldWorkflowToLangGraph(oldNodes, oldEdges, input, apiKeys) {
 ...
 */
async function createWorkflowExecutionStatesTable() {
    try {
    ...
    `;
        ...
        if (error && error.code === "42P01") {
            ...
            console.log("Note: workflow_execution_states table creation requires manual SQL execution");
        ...
        console.error("Error preparing workflow_execution_states migration:", error);
        throw error;
    }
}
/**
 ...
 */
async function updateAgentExecutionsTable() {
    try {
 ...
 * Run all migrations
 */
async function runAdvancedExecutionMigrations() {
    try {
        ...
        console.log("Please execute the provided SQL statements in your Supabase dashboard");
    }
    catch (error) {
 ...
 */
function validateWorkflowCompatibility(nodes, edges) {
    const warnings = [];
    const errors = [];
...
exports.MigrationFeatureFlag = MigrationFeatureFlag;
/**
 ...
 */
exports.GradualMigrationExample = `
...
class MigrationMonitor {
    ...
    recordOldSystemExecution(success, executionTime) {
    ...
    recordNewSystemExecution(success, executionTime) {
    ...
    getReport() {
        ...
        const oldPercentage = total > 0 ? ((this.metrics.oldSystemUsage / total) * 100).toFixed(2) : 0;
        const newPercentage = total > 0 ? ((this.metrics.newSystemUsage / total) * 100).toFixed(2) : 0;
        return `
Migration Report:
================
