...
exports.testSingleEmail = testSingleEmail;
exports.testSendGridEmail = testSendGridEmail;
exports.testMailgunEmail = testMailgunEmail;
exports.testBatchEmails = testBatchEmails;
exports.testNodeIntegration = testNodeIntegration;
...
async function testSingleEmail() {
    ...
    try {
        const result = await (0, emailService_1.sendEmail)(options);
...
async function testBatchEmails() {
    ...
    try {
        const results = await (0, emailService_1.sendEmailBatch)(emails);
